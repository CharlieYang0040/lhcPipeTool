...
class CreateTableDialog(QDialog):
    ...
    def setup_columns_table(self):
        ...
        # 데이터 타입과 제약조건 목록 정의
        self.data_types = ['VARCHAR(255)', 'INTEGER', 'TIMESTAMP', 'BOOLEAN', 'TEXT', 
                          'FLOAT', 'DATE', 'DECIMAL(15,2)', 'CHAR(1)']
        self.constraints = ['', 'NOT NULL', 'PRIMARY KEY', 'UNIQUE', 
                          'PRIMARY KEY NOT NULL', 'UNIQUE NOT NULL']
